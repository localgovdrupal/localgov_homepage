...
namespace Drupal\localgov_homepage\Plugin\Field\FieldWidget;
 ...
 *
 * @package Drupal\localgov_homepage\Plugin\Field\FieldWidget
 *
 *
 * @FieldWidget(
...
class CustomInlineParagraphsWidget extends InlineParagraphsWidget {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    if ($this->getSetting('description_field') !== '_all') {
      ...
      if (key_exists('target_id', $items[$delta]->getValue())) {
